...
void Author::setNationality(std::string nationality) {this->nationality = nationality;}
std::vector<std::string> Author::getAliases()  {return aliases;}
void Author::setAliases(std::vector<std::string> aliases) {this->aliases = aliases;}